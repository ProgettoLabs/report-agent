...
| Product Line | Current Quarter (USD) | Prior Year Quarter (USD) | Notes |
|---|---|---|---|
| Product Line A | 4,200,000 | 3,800,000 | |
| Product Line B | 1,750,000 | 1,600,000 | |

## Revenue by Region
| Region | Current Quarter (USD) | Prior Year Quarter (USD) | Notes |
|---|---|---|---|
| EMEA | 3,100,000 | 2,900,000 | |
| APAC | 2,850,000 | 2,500,000 | |

## Operating Expenses by Department
| Department | Current Quarter (USD) | Prior Year Quarter (USD) | Notes |
|---|---|---|---|
