...
pip install langchain-ollama langchain-openai python-dotenv fastmcp
\end{lstlisting}
...
Pass \texttt{--agent-type local} on the command line, or leave it unset if \texttt{AGENT\_TYPE = "local"} in the code. The agent reads files directly, like Week 1:
